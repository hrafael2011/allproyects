...
namespace ResolviendoUnEjercicio.Ejercicios
{
    ...
    Este primer ejercicio es de prueba, y es solo para que te familiarices con la herramienta. No tienes que hacer nada. Ya el ejercicio está resuelto.
     */
    public class Ejemplo
    {
        public bool DevolverVerdadero()
        {
            return false;
        }
    }
